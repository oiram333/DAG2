        ...
        <div className={`mb-20 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex items-end gap-8 flex-wrap">
            ...
            <p className="hidden md:block text-[#666] text-sm leading-relaxed max-w-xs mb-2">
              Una empresa comprometida con la excelencia constructiva y el diseño de espacios que inspiran.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <div className={`transition-all duration-700 delay-100 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-[#777] leading-relaxed mb-8">
              Nuestro equipo multidisciplinario combina creatividad arquitectónica con sólida experiencia en obras civiles, residenciales y comerciales. Desde el anteproyecto hasta la entrega final, acompañamos a nuestros clientes en cada decisión, garantizando resultados que superan expectativas.
            </p>
          ...
          <div className={`relative transition-all duration-700 delay-200 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <img
              ...
              src="https://readdy.ai/api/search-image?query=modern%20construction%20team%20reviewing%20architectural%20blueprints%20in%20sleek%20minimalist%20office%2C%20dark%20interior%2C%20black%20and%20white%20tones%2C%20professional%20architects%20working%2C%20geometric%20shadows%2C%20clean%20lines%2C%20cinematic%20lighting%2C%20no%20faces%20visible&width=640&height=480&seq=dag2about01&orientation=landscape"
            />
