              ...
              <aside className="lg:col-span-1">
                <div className="border border-[#1e1e1e] p-6 md:p-8 lg:sticky lg:top-28">
                  ...
                  <dl className="space-y-5">
                    ...
                    <div>
                      <dt className="text-[#444] text-xs tracking-[0.3em] uppercase mb-1">Ubicación</dt>
                    ...
                    {project.contact && (
                      <div>
                        <dt className="text-[#444] text-xs tracking-[0.3em] uppercase mb-1">Responsable</dt>
                        <dd className="text-white text-sm">{project.contact}</dd>
                      </div>
                    )}
                  </dl>
